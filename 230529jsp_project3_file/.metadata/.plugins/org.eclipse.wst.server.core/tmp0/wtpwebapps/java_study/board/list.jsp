...
<body>
	<h1 align="center" style="color: green;">소원 리스트</h1>
	<br>
	<!-- 검색라인 -->
	...
	<div align="center">
		<c:if test="${pgh.prev }">
			<a
				...
				style="text-decoration: none; color: green;"> 이전 </a>
		</c:if>
		...
		<c:forEach begin="${pgh.startPage }" end="${pgh.endPage }" var="i">
			...
			<a
				...
				style="text-decoration: none; color: green;">${i } | </a>
		</c:forEach>
		...
		<c:if test="${pgh.next }">
			<a
				...
				style="text-decoration: none; color: green;"> 다음 </a>
		</c:if>
	</div>
