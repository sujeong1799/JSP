...
<body>
	...
	<div style="width: 800px; margin: auto;">
		...
		<div align="center">
		<a href="/brd/page?keyword=${ses.id}&type=w"><button>내가 쓴 글</button></a>
	...
	<div align="center">
		<c:if test="${pgh.prev }">
			<a
				...
				style="text-decoration: none; color: white;"> 이전 </a>
		</c:if>

		<c:forEach begin="${pgh.startPage }" end="${pgh.endPage }" var="i">
			<a href="/brd/page?pageNo=${i }&qty=${pgh.pgvo.qty}&type=${pgh.pgvo.type}&keyword=${pgh.pgvo.keyword}"
		...
		<c:if test="${pgh.next }">
			<a
				...
				style="text-decoration: none; color: white;"> 다음 </a>
		</c:if>
	</div>
